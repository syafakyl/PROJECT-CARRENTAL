<%@ Page Title="" Language="C#" MasterPageFile="~/MasterUser.Master" AutoEventWireup="true" CodeBehind="history.aspx.cs" Inherits="PROJECT_ASP.NET.history" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>History</h2>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" Class="btn btn-primary" NavigateUrl="User.aspx">Kembali</asp:HyperLink>
        </div>
    </div>
    <br>
    <br>
